...
from final_kmeans_dqn import dqn_learning, simulate_path, load_model, Agent, DQN ,plot_losses_from_json,plot_rewards_from_json
...
if __name__ == "__main__":
    ...
    gamma_array = np.array([0.99,0.95,0.9])
